...
ELASTIC_CONNECTION_URL="$([ $USE_HTTPS = true ] && echo "https://" || echo "http://")$([[ $ELASTIC_USER != "" ]] && echo "$ELASTIC_USER:$ELASTIC_PASS@" || echo "")$ELASTIC_URL$([[ $ELASTIC_PORT != "" ]] && echo ":$ELASTIC_PORT" || echo "")"
